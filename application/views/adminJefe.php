...
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); }
  ...
  <?php } ?>
				...
				<?php $atributos = array('id' => 'formfiltrar', 'autocomplete' => 'off', 'class' => 'form-inline' );
					echo form_open('jefe/jefeFilter', $atributos);
				?>
		            ...
		            <?php echo anchor('jefe', 'Limpiar', 'class="btn btn-danger"');?>  
 ...
 -->				  <table data-height="400" class="footable table table-striped table-responsive" >
				  	<thead>
						<tr class="danger">
							...
							<th style="border: hidden" data-class="expand" class="col-sm-2">Nombres y Apellidos</th>
							<th style="border: hidden" data-hide="phone,tablet" class="col-sm-2">Fecha de Nacimiento</th>
			    			...
			    			if(!empty($jefe)){
								foreach ($jefe as $fila): ?>
									<tr>
											...
											<div class="row">
												<div class="form-group">
													<div class="btn-group" role="group" style="padding-left:10px">
															...
															echo form_open('jefe/actualizaJefe', $atributos);
													...
													<div class="btn-group" role="group">
														...
														echo form_open('carga/inicio', $atributos);
														echo form_input(array('name' => 'id', 'id' => 'id', 'value' => $fila->id, 'type'=>'hidden')); ?> 
														<button data-toggle="tooltip" data-placement="top" title="Carga familiar" type="submit" onClick="if(confirmar() == false) return false" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></button>  
														<?php echo form_close(); ?>
													</div>
												</div>
											</div>
										...
										<td style="border: hidden"><div><?php echo $fila->fecha_nac; ?></div></td>
										<td style="border: hidden"><div><?php echo $fila->cedula; ?></div></td>									
										<td style="border: hidden"><div><?php echo $fila->telefono; ?></div></td>									
										<td style="border: hidden">
											<div class="row">
												<div class="form-group">
													<div class="btn-group" role="group" style="padding-left:10px">
															<?php $atributos = array('id' => 'editForm', 'class'=>'form-inline', 'autocomplete' => 'off', );
															echo form_open('costanciaResidenciaJ/', $atributos);
															echo form_input(array('name' => 'id', 'id' => 'id', 'value' => $fila->id, 'type'=>'hidden')); ?> 
													...
													<div class="btn-group" role="group" style="padding-left:10px">
															<?php $atributos = array('id' => 'editForm', 'class'=>'form-inline', 'autocomplete' => 'off', );
															echo form_open('constanciaCompraJ/', $atributos);
															echo form_input(array('name' => 'id', 'id' => 'id', 'value' => $fila->id, 'type'=>'hidden')); ?> 
													...
													<div class="btn-group" role="group" style="padding-left:10px">
															<?php $atributos = array('id' => 'editForm', 'class'=>'form-inline', 'autocomplete' => 'off', );
															echo form_open('constanciaSolteriaJ/', $atributos);
															echo form_input(array('name' => 'id', 'id' => 'id', 'value' => $fila->id, 'type'=>'hidden')); ?> 
													...
													<div class="btn-group" role="group" style="padding-left:10px">
															<?php $atributos = array('id' => 'editForm', 'class'=>'form-inline', 'autocomplete' => 'off', );
															echo form_open('bajosRecursosJ/', $atributos);
															echo form_input(array('name' => 'id', 'id' => 'id', 'value' => $fila->id, 'type'=>'hidden')); ?> 
