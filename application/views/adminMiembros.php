	...
	<div class='container content_middle'>   
  	  <div class="panel panel-danger">
		  <div class="panel-heading">
		    <h3 class="panel-title">Datos de los miembros</h3>
		  </div>
					...
					<table data-height="350" class="footable table table-striped table-responsive" >
					  	<thead >
							<tr class="danger">
								...
								<th style="border: hidden" data-hide="phone,tablet" class="col-sm-1">Apellido</th>
								<th style="border: hidden" data-hide="phone,tablet" class="col-sm-1">Cédula</th>
								<th style="border: hidden" data-hide="phone,tablet" class="col-sm-1">Comisión</th>
							</tr>	
					    </thead>
			    			...
			    			if(!empty($consejo)){
								foreach ($consejo as $fila): ?>
									<tr>
											...
											<div class="row">
												<div class="form-group">
													<div class="btn-group" role="group" style="padding-left:10px">
															...
															echo form_open('miembros/actualizaMiembros', $atributos);
													...
													<div class="btn-group" role="group">
														...
														echo form_open('miembros/delete', $atributos);
														echo form_input(array('name' => 'id', 'id' => 'id', 'value' => $fila->id, 'type'=>'hidden')); ?> 
										...
										<td style="border: hidden"><div><?php echo $fila->apellido; ?></div></td>
										<td style="border: hidden"><div><?php echo $fila->cedula; ?></div></td>										
										<td style="border: hidden"><div><?php echo $fila->nombre_comision; ?></div></td>										
