  ...
  <div class="panel panel-danger">
    ...
    <div class="panel-body">
     <div id="container" name="container" class="vertical-align" style="height: 450px;">
      <?php $atributos = array('id' => 'recorridoForm2', 'autocomplete' => 'off', 'novalidate');
        echo form_open('/carga/create', $atributos); ?> 
      <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
          <div class="form-group">
            <?php echo form_input(array('name' => 'calle', 'class' => 'form-control', 'id' => 'calle',  'placeholder'=>'Indique la calle de residencia', 'aria-describedby'=>'sizing-addon2')); ?>
          </div>
        </div>
          <div class="col-md-4">  
            <div class="form-group">
